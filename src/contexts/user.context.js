...
import { App, Credentials } from "realm-web";
 import { app } from "../mongo/config"
 import { login, signup, logout, confirmEmail } from "../mongo/auth";
...
export const UserProvider = ({ children }) => {
 ...
 return <UserContext.Provider value={{ user, setUser, fetchUser, login, signup, logout }}>
   {children}
